...
const query = async (text, params) => {
	...
	const res = await bdPoll.query(text, params)
...
const getClient = async () => {
	const client = await bdPoll.connect()
...
module.exports = { coodeshConnection }